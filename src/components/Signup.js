...
export default function Signup(props) {
  ...
  const handleSignup = async (e) => {
    ...
    const response = await fetch("https://scribbly-backend-bwyp.onrender.com/api/auth/createuser", {
      method: 'POST',
      headers: {
    ...
    if (json.success) {
      ...
      navigate("/");
      props.showalert("Account created successfully", "success");  // show success alert
    }
    else {
      props.showalert("Invalid credentials", "danger");  // show error alert
    }
